      ...
      <Card className="p-4 grid gap-4">
        <form onSubmit={onSearch} className="flex flex-col sm:flex-row gap-2">
          ...
          <div className="flex gap-2 sm:ml-0">
            <button className="w-full sm:w-auto rounded-lg border border-white/20 bg-white/10 px-4 py-2 hover:bg-white/20" type="submit">Sök</button>
            <button className="w-full sm:w-auto rounded-lg border border-white/20 bg-white/10 px-4 py-2 hover:bg-white/20" type="button" onClick={useMyLocation}>Använd min plats</button>
          </div>
        </form>
